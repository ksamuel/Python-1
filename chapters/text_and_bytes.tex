...
So read it with attention, it will make all Python coding, present and future, way clearer. First, we'll start with a deep explanation on how things work. We'll only focus on the differences between Python 2 and 3 after that.
...
Of course, unless you have a very good reason (client forces you, old spec, legacy system, embded device with limited resources...), always use UTF-8.
