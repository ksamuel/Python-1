...
Those ones need to be part of an entire chapter: encoding is notoriously misunderstood and you need to know what you're doing to have a happy migration. See \textquote{Bytes and text}.
